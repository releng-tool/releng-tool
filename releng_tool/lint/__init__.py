...
def lint(opts: RelengEngineOptions, pkgs: list[RelengPackage]) -> bool:
    ...
    from releng_tool.lint.rt105 import rt105
    from releng_tool.lint.rt106 import rt106
    from releng_tool.lint.rt107 import rt107
    from releng_tool.lint.rt108 import rt108
    from releng_tool.lint.rt109 import rt109
    from releng_tool.lint.rt110 import rt110
    from releng_tool.lint.rt111 import rt111
    from releng_tool.lint.rt112 import rt112
    from releng_tool.lint.rt113 import rt113
    ...
    for pkg in pkgs:
        ...
        rt105(state, pkg, nodes)
        rt106(state, pkg, nodes)
        rt107(state, pkg, nodes)
        rt108(state, pkg, nodes)
        rt109(state, pkg, nodes)
        rt110(state, pkg, nodes)
        rt111(state, pkg, nodes)
        rt112(state, pkg, nodes)
        rt113(state, pkg, nodes)
