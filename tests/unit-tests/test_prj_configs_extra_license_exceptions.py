...
class TestPrjConfigsExtraLicenseExceptions(TestDefaultEngineBase):
    def test_prjconfig_extra_license_exceptions_cfgcall_invalid(self):
        self.newprjcfg('''\
releng_config(
    packages = [
        'minimal',
    ],
    extra_license_exceptions=1,
)
''')
    ...
    def test_prjconfig_extra_license_exceptions_cfgcall_valid(self):
        self.newprjcfg('''\
releng_config(
    packages = [
        'minimal',
