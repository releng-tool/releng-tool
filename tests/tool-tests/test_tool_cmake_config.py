...
class TestToolCmakeConfig(TestSiteToolBase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
    ...
    def test_tool_cmake_config_default(self):
        rv = self.engine.run()
        self.assertTrue(rv)
    ...
    def test_tool_cmake_config_host(self):
    ...
    def test_tool_cmake_config_staging_only(self):
    ...
    def test_tool_cmake_config_staging_and_target(self):
    ...
    def test_tool_cmake_config_noinstall(self):
    ...
    def test_tool_cmake_config_toolchain(self):
