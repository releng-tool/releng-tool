...
class TestToolPythonSetuptoolsInstaller(PythonSiteToolBase):
    @classmethod
    def setUpClass(cls):
    ...
    def tool_template(self):
        return 'python-setuptools-installer'

    def test_tool_python_setuptools_installer_default(self):
        rv = self.engine.run()
        self.assertTrue(rv)
    ...
    def test_tool_python_setuptools_installer_host(self):
    ...
    def test_tool_python_setuptools_installer_staging(self):
    ...
    def test_tool_python_setuptools_installer_staging_and_target(self):
